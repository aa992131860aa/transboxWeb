...
<div id="superContainer" style="top: 0px;">
    ...
    <div class="section section1" data-anchor="page1" style="height: 755px;">
        ...
        <!--文字-->
        <div class="bg1_03 pwhile p36 wow fadeInDown animated animated" data-wow-delay="0.5s">
    ...
    <div class="section section2" data-anchor="page2">
        ...
        <div class="bg2_02 p18 wow pwhile fadeInDown animated animated" data-wow-delay="1s"><center><span class="p18">${title}</span> <p></p><strong
                class="p25" id="page2_title">器官类型比例</strong></center></div>
        <div class="bg2_03"><img src="/resources/img/icon_form.png" style="vertical-align: middle;margin-right: 10px;"
                                 alt=""/><span
                style="">器官类型占比(%)</span></div>
    ...
    <div class="section section3" data-anchor="page3">
        ...
        <div class="bg2_02 p18 wow pwhile fadeInDown animated animated" data-wow-delay="1s"><center><span class="p18">${title}</span>:<br/><strong
                class="p25" id="page3_title">器官来源分析</strong></center></div>
        <div class="bg2_03"><img src="/resources/img/icon_form.png" style="vertical-align: middle;margin-right: 10px;"
                                 alt=""/><span
                style="">各省转运数量(次)</span></div>

    </div>
    <div class="section section4" data-anchor="page4">
        <div class="bg2"></div>
        <div class="bg2_01"></div>
        <div class="bg2_04" id="container4"></div>
        <!--<div class="bg2_05"></div>-->
        <!--<div class="bg2_06"></div>-->
        <!--<div class="bg2_07"></div>-->

        <div class="bg2_02 p18 wow pwhile fadeInDown animated animated" data-wow-delay="1s"><span class="p18">${title}</span>:<br/><strong
                class="p25" id="page4_title">大部分转运时长处于12-18小时,占比68%</strong></div>
        <div class="bg2_03"><img src="/resources/img/icon_form.png" style="vertical-align: middle;margin-right: 10px;"
                                 alt=""/><span
                style="">转运耗时情况(小时)</span></div>
    ...
    <div class="section section5" data-anchor="page5">
        ...
        <div class="bg2_02 p18 wow pwhile fadeInDown animated animated" data-wow-delay="1s"><span class="p18">${title}</span>:<br/><strong
                class="p25" id="page5_title">注意!温度异常占比高达68%</strong></div>
        <div class="bg2_03"><img src="/resources/img/icon_form.png" style="vertical-align: middle;margin-right: 10px;"
                                 alt=""/><span
                style="">发生异常占比</span></div>

    </div>
    <div class="section section6" data-anchor="page6">
        <div class="bg2"></div>
        <div class="bg2_01"></div>
        <div class="bg2_04" id="container6"></div>
        <!--<div class="bg2_05"></div>-->
        <!--<div class="bg2_06"></div>-->
        <!--<div class="bg2_07"></div>-->

        <div class="bg2_02 p18 wow pwhile fadeInDown animated animated" data-wow-delay="1s"><span class="p18">${title}</span>:<br/><strong
                class="p25" id="page6_title">最常用的交通工具是救护车</strong></div>
        <div class="bg2_03"><img src="/resources/img/icon_form.png" style="vertical-align: middle;margin-right: 10px;"
                                 alt=""/><span
                style="">图表内容</span></div>
    ...
    <div class="section section7" data-anchor="page7">
        ...
        <div class="bg2_02 p18 wow pwhile fadeInDown animated animated" data-wow-delay="1s"><span class="p18">${title}</span>:<br/><strong
                class="p25" id="page7_title">王医生</strong></div>
        <div class="bg2_03"><img src="/resources/img/icon_form.png" style="vertical-align: middle;margin-right: 10px;"
                                 alt=""/><span
                style="">医师工作量(次)</span></div>

    </div>
    <div class="section section8" data-anchor="page8">
        <div class="bg2"></div>
        <div class="bg2_01"></div>
        <div class="bg2_04" id="container8"></div>
        <!--<div class="bg2_05"></div>-->
        <!--<div class="bg2_06"></div>-->
        <!--<div class="bg2_07"></div>-->

        <div class="bg2_02 p18 wow pwhile fadeInDown animated animated" data-wow-delay="1s"><span class="p18">${title}</span>:<br/><strong
                class="p25" id="page8_title">34523号箱子使用率最高</strong></div>
        <div class="bg2_03"><img src="/resources/img/icon_form.png" style="vertical-align: middle;margin-right: 10px;"
                                 alt=""/><span
                style="">箱子使用次数(次)</span></div>
